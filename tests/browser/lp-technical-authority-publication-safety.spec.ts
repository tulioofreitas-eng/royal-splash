...
const cases = [
  ...
  },
  {
    route: "/lp/vazamento",
    forbidden: [
      /Encontramos o vazamento/i,
      /Detecção eletrônica/i,
      /sem quebrar/i,
      /sem esvaziar/i,
      /ponto exato/i,
      /tentativa e erro/i,
      /equipamentos de detecção acústica/i,
      /testes de pressão/i,
      /sem quebra-quebra desnecessário/i,
      /Detecção sem quebra desnecessária/i,
      /Diagnóstico rápido e preciso/i,
      /Diagnóstico Preciso/i,
      /geofone eletrônico/i,
      /teste de pressão/i,
      /piscina cheia/i,
      /com exatidão/i,
      /Equipamentos de detecção acústica e pressão/i,
      /Não fazemos quebra por tentativa/i,
      /detecção acústica é mais eficaz/i,
    ...
    preserved: [
      /Correção estrutural, de tubulação ou revestimento/i,
